...
var _user$project$EnPlot$series = function (plot) {
	return A2(
		_terezka$elm_plot$Plot$viewSeries,
		{
			ctor: '::',
			_0: _terezka$elm_plot$Plot$area(
				_elm_lang$core$List$map(
					function (_p0) {
						var _p1 = _p0;
...
var _user$project$EnPlot$Point = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$EnPlot$decodePoint = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$EnPlot$Point,
...
var _user$project$EnPlot$Plot = F3(
	function (a, b, c) {
		return {x_axis_label: a, y_axis_label: b, data: c};
	});
var _user$project$EnPlot$decodePlot = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$EnPlot$Plot,
	A2(_elm_lang$core$Json_Decode$field, 'x_axis_label', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'y_axis_label', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode$field,
		'data',
		_elm_lang$core$Json_Decode$list(_user$project$EnPlot$decodePoint)));

var _user$project$Highlight$highlight = _elm_lang$core$Native_Platform.outgoingPort(
	'highlight',
	function (v) {
		return null;
	});
...
var _user$project$App$codeBlock = F2(
	function (a, lang) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', lang),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$App$rawHtml = function (string) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$App$render = function (data) {
	var _p0 = data.kind;
	switch (_p0.ctor) {
		case 'Text':
			return A2(_user$project$App$codeBlock, data.content, 'Elixir');
		case 'HTML':
			return _user$project$App$rawHtml(data.content);
		case 'Plot':
			var _p1 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$EnPlot$decodePlot, data.content);
			if (_p1.ctor === 'Ok') {
				return _user$project$EnPlot$series(_p1._0);
			} else {
				return A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Invalid data returned. This should never happen. Please file a bug.'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Args:'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(data.content),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
...
var _user$project$App$drawCells = F2(
	function (inputCell, outputCell) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'input-cell'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(_user$project$App$codeBlock, inputCell, 'elixir'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'output-cell'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _user$project$App$render(outputCell),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$App$drawCellsList = F2(
	function (inputCells, outputCells) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'cell'),
				_1: {ctor: '[]'}
			},
			A3(
				_elm_lang$core$List$foldr,
				...
				A3(
					...
					F2(
						function (inputCell, outputCell) {
							return {
								ctor: '::',
								_0: A2(_user$project$App$drawCells, inputCell, outputCell),
								_1: {ctor: '[]'}
							};
						}),
					_elm_lang$core$List$reverse(inputCells),
					_elm_lang$core$List$reverse(outputCells))));
	});
var _user$project$App$Model = F6(
	function (a, b, c, d, e, f) {
		return {outputCells: a, inputCells: b, phoenixSocket: c, inputState: d, shiftDown: e, updatedAt: f};
	});
var _user$project$App$ChatMessage = F2(
	function (a, b) {
		return {user: a, body: b};
	});
var _user$project$App$Renderable = F2(
	function (a, b) {
		return {kind: a, content: b};
	});
var _user$project$App$Highlight = function (a) {
	return {ctor: 'Highlight', _0: a};
};
var _user$project$App$SetUpdatedAt = function (a) {
	return {ctor: 'SetUpdatedAt', _0: a};
};
...
var _user$project$App$init = function () {
	...
	var _p2 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join, channel, socket);
	...
	return {
		...
		_0: {
			...
			inputState: '',
			shiftDown: false,
			updatedAt: _elm_lang$core$Maybe$Nothing
		},
...
var _user$project$App$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phoenixSocket, _user$project$App$PhoenixMsg),
			_1: {
				ctor: '::',
...
var _user$project$App$inputStateForm = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: A2(_elm_lang$html$Html_Attributes$attribute, 'id', 'cellForm'),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$textarea,
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'form-control'),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'form', 'cellForm'),
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'outline-color:#FF29D2;outline-width:1px;outline-style:solid'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(model.inputState),
									_1: {
										ctor: '::',
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$App$drawCellsList, model.inputCells, model.outputCells),
						_1: {
							ctor: '::',
							_0: _user$project$App$inputStateForm(model),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$App$KindError = function (a) {
	return {ctor: 'KindError', _0: a};
};
var _user$project$App$Plot = {ctor: 'Plot'};
var _user$project$App$HTML = {ctor: 'HTML'};
var _user$project$App$Text = {ctor: 'Text'};
var _user$project$App$decodeRenderableKind = function (string) {
	var _p3 = _elm_lang$core$String$toLower(string);
	switch (_p3) {
		case 'text':
			return _user$project$App$Text;
		case 'html':
			return _user$project$App$HTML;
		case 'plot':
			return _user$project$App$Plot;
		default:
			return _user$project$App$KindError(
				A2(_elm_lang$core$Basics_ops['++'], 'cannot parse kind ', string));
	}
};
var _user$project$App$renderableKindDecoder = A2(_elm_lang$core$Json_Decode$map, _user$project$App$decodeRenderableKind, _elm_lang$core$Json_Decode$string);
var _user$project$App$renderableDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$App$Renderable,
	A2(_elm_lang$core$Json_Decode$field, 'kind', _user$project$App$renderableKindDecoder),
...
var _user$project$App$chatMessageDecoder = A3(
	...
	A2(_elm_lang$core$Json_Decode$field, 'body', _user$project$App$renderableDecoder));
		...
		while (true) {
			...
			switch (_p4.ctor) {
				case 'SendMessage':
					var payload = _elm_lang$core$Json_Encode$object(
						{
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'body',
									_1: _elm_lang$core$Json_Encode$string(model.inputState)
								},
								_1: {ctor: '[]'}
							}
						});
					...
					var _p5 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push_, model.phoenixSocket);
					var phoenixSocket = _p5._0;
					var phxCmd = _p5._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								inputCells: {
									ctor: '::',
									_0: _elm_lang$core$String$trim(model.inputState),
									_1: model.inputCells
								}
							}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App$PhoenixMsg, phxCmd)
				...
				case 'ReceiveChatMessage':
					var _p6 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$App$chatMessageDecoder, _p4._0);
					if (_p6.ctor === 'Ok') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									outputCells: {ctor: '::', _0: _p6._0.body, _1: model.outputCells}
								}),
							{
								ctor: '::',
								_0: A2(_elm_lang$core$Task$perform, _user$project$App$SetUpdatedAt, _elm_lang$core$Time$now),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$core$Task$perform,
										_user$project$App$Highlight,
				...
				case 'KeyDown':
					return _elm_lang$core$Native_Utils.eq(_p4._0, 16) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{shiftDown: true}),
				...
				case 'KeyUp':
					var _p7 = _p4._0;
					if (_elm_lang$core$Native_Utils.eq(_p7, 16)) {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						if (model.shiftDown && _elm_lang$core$Native_Utils.eq(_p7, 13)) {
							var _v5 = _user$project$App$SendMessage,
								_v6 = model;
							msg = _v5;
							model = _v6;
							continue update;
				...
				case 'PhoenixMsg':
					var _p8 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p4._0, model.phoenixSocket);
					var phoenixSocket = _p8._0;
					var phxCmd = _p8._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
				...
				case 'SetUpdatedAt':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								updatedAt: _elm_lang$core$Maybe$Just(
				...
				default:
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Highlight$highlight(
							{ctor: '_Tuple0'})
					};
			}
		}
...
if (typeof _user$project$App$main !== 'undefined') {
    _user$project$App$main(Elm['App'], 'App', {"types":{"unions":{"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"App.Msg":{"args":[],"tags":{"SendMessage":[],"Highlight":["()"],"ReceiveChatMessage":["Json.Encode.Value"],"Input":["String"],"PhoenixMsg":["Phoenix.Socket.Msg App.Msg"],"KeyUp":["Keyboard.KeyCode"],"SetUpdatedAt":["Time.Time"],"KeyDown":["Keyboard.KeyCode"]}},"Phoenix.Socket.Msg":{"args":["msg"],"tags":{"ChannelErrored":["String"],"ChannelClosed":["String"],"ExternalMsg":["msg"],"ChannelJoined":["String"],"Heartbeat":["Time.Time"],"NoOp":[],"ReceiveReply":["String","Int"]}}},"aliases":{"Keyboard.KeyCode":{"args":[],"type":"Int"},"Time.Time":{"args":[],"type":"Float"}},"message":"App.Msg"},"versions":{"elm":"0.18.0"}});
}
