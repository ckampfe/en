		...
		while (true) {
			...
			switch (_p3.ctor) {
				case 'SendMessage':
					...
					var _p4 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push_, model.phoenixSocket);
					...
					if (_p5.ctor === 'Ok') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									outputCells: {ctor: '::', _0: _p5._0.body, _1: model.outputCells}
								}),
							{
								ctor: '::',
				...
				case 'KeyDown':
					return _elm_lang$core$Native_Utils.eq(_p3._0, 16) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{shiftDown: true}),
				...
				case 'KeyUp':
					var _p6 = _p3._0;
					if (_elm_lang$core$Native_Utils.eq(_p6, 16)) {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						if (model.shiftDown && _elm_lang$core$Native_Utils.eq(_p6, 13)) {
							var _v4 = _user$project$App$SendMessage,
								_v5 = model;
							msg = _v4;
							model = _v5;
							continue update;
				...
				case 'PhoenixMsg':
					var _p7 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p3._0, model.phoenixSocket);
					var phoenixSocket = _p7._0;
					var phxCmd = _p7._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								updatedAt: _elm_lang$core$Maybe$Just(
									_elm_lang$core$Time$inMilliseconds(_p3._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				default:
